...
namespace RealEstateApp.ViewModels
{
    public class MenuViewModel : ViewModelBase
    {
        ...
        public ICommand ItemSelectedCommand => new Xamarin.Forms.Command<MenuItem>(SelectMenuItemAsync);
        ...
        {
            if (item.IsEnabled) await NavigationService.NavigateToAsync(item.ViewModelType, null);
        }
    }
}